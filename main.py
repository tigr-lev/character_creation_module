...
class Character: 
    ...
    RANGE_VALUE_ATTACK = (1, 3) # Константа диапазон урона.
    RANGE_VALUE_DEFENCE = (1,5) # Константа диапазон защиты.
    SPECIAL_BUFF = 15           # Спец.скил
    SPECIAL_SKILL = 'Удача'     # Спец.скил
